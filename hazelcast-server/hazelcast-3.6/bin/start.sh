...
export CLASSPATH=$HAZELCAST_HOME/lib/hazelcast-all-3.6.jar
...
if [ -z "${PID}" ]; then
    ...
    echo "Another hazelcast instance is already started in this folder. To start a new instance, please unzip 3.6.zip/tar.gz in a new folder."
    exit 0
fi
